...
var EditPokemonComponent = /** @class */ (function () {
    function EditPokemonComponent(route, router, _pokemonService) {
        this.route = route;
        this.router = router;
    ...
    EditPokemonComponent = __decorate([
        ...
        __metadata("design:paramtypes", [router_1.ActivatedRoute, router_1.Router, pokemon_service_1.PokemonService])
